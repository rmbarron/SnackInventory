...
func TestListContents(t *testing.T) {
	...
	if err := listContents(nil, nil); err != nil {
		t.Errorf("listContents(nil, nil) = got err %v, want err nil", err)
	}
}

func TestListContents_ServerError(t *testing.T) {
	fsi := &fakeserver.FakeSnackInventoryServer{
	...
	if err := listContents(nil, nil); err == nil {
		t.Error("listContents(nil, nil) = got err nil, want err")
	}
}
